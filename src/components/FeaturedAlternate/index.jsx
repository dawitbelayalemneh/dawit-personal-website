...
const projects = [
  {
    ...
    heading: "Tomato Restaurant",
    description:
      "<p>The Tomato Restaurant Website is a React-based application designed to provide a seamless, interactive user experience for restaurant customers. It combines modern web development technologies with an intuitive design to showcase the restaurant's menu, services, and ambiance.</p>",
    githubLink: "https://github.com/dawitbelayalemneh/Tomato-food-delivery-app.git",
    // techno
    html: true,
    css: true,
    javascript: true,
  ...
  {
    id: 2,
    heading: "Project Management App",
    description:
      "<Also>One of my first freelance project.<p/> <br/> <p>The Project Management App is a versatile tool designed to streamline and optimize the process of managing tasks, teams, and projects. It offers a variety of features that allow users to efficiently plan, track, and execute their work.</p>",
    githubLink: "https://github.com/dawitbelayalemneh/project-management-app.git",
    html: true,
    css: true,
    javascript: true,
    react: true,
  ...
  {
    id: 3,
    heading: "Fancy Fast Food Explorer",
    description:
      "<p>Fancy Fast Food Explorer is an engaging and user-friendly web application designed to help users discover a wide variety of gourmet fast food options. The app provides a dynamic platform for food enthusiasts to explore an extensive collection of trendy and innovative fast food items, ranging from classic favorites to unique and creative dishes.</p>",
    githubLink: "https://github.com/dawitbelayalemneh/Ama-zone-restaurant.git",
    // techno
    html: true,
    css: true,
    javascript: true,
                    ...
                    >
                      ...
                      <span className="flex flex-row gap-3 items-center px-4 py-3 transition-transform bg-transparent border border-current group-hover:-translate-x-1 group-hover:-translate-y-1">
                        <svg
                          ...
                          className="w-6 h-6 text-secondary-800 dark:text-secondary-50 fill-current"
                        >
                          <path
